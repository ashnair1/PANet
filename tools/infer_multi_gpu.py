...
def parse_args():
    ...
    parser.add_argument(
        '--start_index', type=int, default=True)
    parser.add_argument(
        '--stop_index', type=int, default=True)
...
def main():
    ...
    maskRCNN.eval()
    if args.image_dir:
        imglist = misc_utils.get_imagelist_from_dir(args.image_dir)[args.start_index:args.stop_index]
    else:
        imglist = args.images
